...
samtools mpileup -A -q 4 -t AD,DP -l $path/SNPs/hg19_snp150_rmi.bed -f $path/Hsapiens.GRCh37_72.fa $path/$family/markdup_*.bam -g | bcftools call -m - -O b -f GQ > $path/$family/hg19_snp150_markdup_rmi_hisat_$family.q4.bcf
